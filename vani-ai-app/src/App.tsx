          ...
          <aside className="w-56 bg-[#0d0d0d] flex flex-col">
            <div className="flex-1 flex flex-col overflow-hidden py-3">
              ...
              <div className="flex-1 overflow-y-auto px-2 custom-scrollbar">
                {/* Generating placeholder - shown when script is being generated */}
                {isGeneratingScript && !data && (
                  <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/[0.08]">
                    <Loader2 size={16} className="shrink-0 text-white/60 animate-spin" strokeWidth={1.5} />
                    <span className="text-[13px] text-white/60 truncate">Generating...</span>
                  </div>
                )}
                {library.length === 0 && !isGeneratingScript ? (
